pipeline {
    ...
    stages {
        ...
        stage('SonarQube') {
            steps {
                echo 'pass'
                sonar-scanner -Dsonar.projectKey=django-eco -Dsonar.sources=/var/lib/jenkins/workspace/django -Dsonar.host.url=https://9000-port-b2d66ea8ecf04937.labs.kodekloud.com
            }
        }
