        ...
        stage('SonarQube') {
            steps {
                //withEnv(["SONAR_TOKEN=${env.SONAR_TOKEN}"]) {
                    echo 'pass'
                    sh "/var/lib/jenkins/.sonar/sonar-scanner-4.7.0.2747-linux/bin/sonar-scanner -Dsonar.projectKey=django-eco -Dsonar.sources=. -Dsonar.host.url=https://9000-port-9419209edd874ff8.labs.kodekloud.com/ -Dsonar.login=sqp_752784e70a4d974161e2191c75412fadcdcaca73"
                //}
            }
        }
