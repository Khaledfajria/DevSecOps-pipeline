...
RUN mkdir app
RUN wget wget http://css:css@20.163.172.235:8081/repository/Djecommerce-artifact/repository/Djecommerce-artifact/zed/Django-ecommerce/1.1.280/Django-ecommerce-1.1.280-file.tar.gz
RUN pwd && ls
